$(document).ready(function() {
	var uid = $('#user').text();
	$.post( "https://graduate-dev.asu.edu/sites/all/modules/playgroundmodule/Test/user.php", {q: uid}, function( data ) {
		$("#UserPane").html(data);
	});
...
function displayParams() {
	$.post("https://graduate-dev.asu.edu/sites/all/modules/playgroundmodule/Test/displayParams.php", function(data) {
...
function submitAddEdit() {
	...
	value['uid'] = $('#user').text();
	$.post("https://graduate-dev.asu.edu/sites/all/modules/playgroundmodule/Test/addedit.php", {d: value}, function(data) {
		location.reload();
		//alert(data);
	});
}
...
function loadAddEditData(date) {
	...
	post['date'] = date;
	post['uid'] = $('#user').text();
	$.post("https://graduate-dev.asu.edu/sites/all/modules/playgroundmodule/Test/populateAddEditform.php", {d: post}, function(data){
		var dataArr = JSON.parse(data);
		if(dataArr === null){
...
function generateReport(){
	...
	if (days <= 0) {
		...
		$.post("https://graduate-dev.asu.edu/sites/all/modules/playgroundmodule/Test/report.php", {start: start, end: end, days: days}, function(data) {
...
function InitHighChart(type,render)
{
	...
	$.post("https://graduate-dev.asu.edu/sites/all/modules/playgroundmodule/Test/chart.php", {param: type}, function(data) {
		//alert(data);
		var dataArr = JSON.parse(data);
...
function InitReportHighChart(type,render, start, end, days)
{
	...
	$.post("https://graduate-dev.asu.edu/sites/all/modules/playgroundmodule/Test/reportChart.php", {param: type, start: start, end: end, days: days}, function(data) {
		//alert(data);
		var dataArr = JSON.parse(data);
		options.xAxis.categories = dataArr.categories;
		options.series[0].name = type;
